...
[![Build Status](https://travis-ci.org/MetaCoq/metacoq.svg?branch=popl-artifact-eval)](https://travis-ci.org/MetaCoq/metacoq)
...
POPL Artifact
-------------
Artifact for POPL submission Coq Coq Correct!

This archive contains the whole development as source (from 
https://github.com/MetaCoq/metacoq/tree/popl-artifact-eval). 
If you only want to browse the files a "light" documentation is available in
...
Alternatively, to build locally you can first install Coq and Equations:
    ...
    # opam install coq.8.9.1 coq-equations.1.2+8.9
...
And build the doc with
  ...
  - The `checker` directory contains some metatheory of the
    ...
    no links to the current paper and should not be considered 
    as part of the artifact for evaluation.

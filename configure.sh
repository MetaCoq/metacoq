...
then
    ...
    then
        ...
        # The safechecker plugin depends on the checker and pcuic
        ...
        SAFECHECKER_DEPS="-I ${COQLIB}/user-contrib/MetaCoq/PCUIC"
        ERASURE_DEPS="-I ${COQLIB}/user-contrib/MetaCoq/SafeChecker"
    fi
    ...
    echo ${CHECKER_DEPS} ${PCUIC_DEPS} ${SAFECHECKER_DEPS} ${ERASURE_DEPS} >> erasure/metacoq-config
else

...
Section Wcbv.
  ...
  Proof.
    ...
    solve_discr => //. depelim H. rewrite e.
...
Proof.
  ...
  - intros ev. revert ev.
    ...
    noconf H.
    * rewrite -{1}[tApp _ _](mkApps_app _ _ [a']). eexists. split => //.
      eapply All2_app; eauto.
      eapply All2_impl; tea; cbv beta; intros ? ? [ev hev].
      exists ev. cbn. lia.
      constructor; auto. exists ev2.
      cbn. lia.
    * subst f'. 
      exists (x0 ++ [a'])%list.
      rewrite mkApps_app /= //.

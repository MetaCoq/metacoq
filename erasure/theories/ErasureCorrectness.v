...
Lemma is_prop_subst_instance:
  forall (u : Instance.t) (x0 : Universe.t), Universe.is_prop x0 -> Universe.is_prop (UnivSubst.subst_instance_univ u x0).
Proof.
(*   intros u x0 i. destruct x0; cbn in *; try congruence. *)
(*   unfold Universe.is_prop in *. unfold Universe.level in *. *)

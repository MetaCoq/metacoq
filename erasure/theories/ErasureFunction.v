...
Proof.
  ...
  - destruct decl as [decl [body hd]].
    ...
    generalize (same_lookup_ind_decl hl ind H). rewrite -{1}e0 -{1}e.
    destruct x => //. cbn. cbn.
  ...
  - cbn -[infer].
    ...
    { epose proof (abstract_env_ext_exists X) as [[Σ wfΣ]].
      ...
      destruct (wi' _ wfΣ'). inv X0.
      pose proof (wt _ wfΣ).
      destruct isdecl, H. inv X0.
      destruct H0. destruct isdecl as [[] ?].
      unfold declared_minductive in *.
      now eapply (hl Σ wfΣ Σ' wfΣ'). }        
    destruct (PCUICSafeReduce.inspect (lookup_ind_decl _ X' ind)).
  ...
  - cbn -[infer].
    ...
    { epose proof (abstract_env_ext_exists X) as [[Σ wfΣ]].
      ...
      destruct (wi' _ wfΣ'). inv X0.
      pose proof (wt _ wfΣ).
      inv H. inv X0. destruct H1 as [[[]]]. destruct H2 as [[[]]].
      unfold declared_minductive in *.
      now eapply (hl Σ wfΣ Σ' wfΣ'). } 

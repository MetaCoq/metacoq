...
Definition inh {cf:checker_flags} (Σ : wf_env_ext) Γ T := ∑ t, forall Σ0 : global_env_ext, abstract_env_rel' Σ Σ0 -> ∥ typing Σ0 Γ t T ∥.

Definition check_inh (Σ : wf_env_ext) Γ (wfΓ : forall Σ0 : global_env_ext, abstract_env_rel' Σ Σ0 -> ∥ wf_local Σ0 Γ ∥) t {T} : typing_result (inh Σ Γ T) := 
...
Proof.
  ...
  abstract_env_rel' gctx_wf_env Σ0 -> ∥ wf_local Σ0 [] ∥) by do 2 constructor.

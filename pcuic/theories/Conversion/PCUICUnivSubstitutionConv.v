...
Proof.
  ...
  induction ((List.rev (to_nonempty_list n).2)); cbn; congruence.
Qed.
(*
...
Lemma In_subst_instance x u (l : nonEmptyUnivExprSet) :
...
Proof.
  ...
  unfold is_lSet in *. unfold_rel_val eqn:H.

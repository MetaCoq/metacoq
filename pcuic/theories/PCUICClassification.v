...
Section classification.
  ...
  Proof using wfΣ.
    ...
    - simpl. intros; eapply invert_red_axiom in hbod; tea. 2:{ eapply into_closed_red. apply red1_red. apply X. fvs. fvs. } subst. exists []. split => //.
    - rewrite mkApps_app /=; intros.
      depelim X; solve_discr.
      depind clrel_rel; solve_discr.
      * destruct args using rev_case; solve_discr. noconf H. rewrite mkApps_app in H; noconf H. solve_discr.
      * specialize (IHargs N1); forward IHargs. constructor; fvs. cbn in clrel_src. rtoProp; intuition auto.
      ...
      * exists (args ++ [N2]). rewrite mkApps_app /=. split => //.
        ...
        eapply All2_app => //.
        eapply All_All2; tea; cbn; bool. eapply closed_red_refl; fvs. eapply All2_tip, into_closed_red; tea. now constructor.
  Qed.
  ...
  Proof.
    ...
    induction rel. eapply prefl; tea.
    eapply ptrans; tea. eapply into_closed_red; tea. now eapply red1_red.
    split; fvs. now eapply clos_rt_rt1n_iff. eapply pred. split; fvs.
    eapply IHrel. fvs.
  Qed.

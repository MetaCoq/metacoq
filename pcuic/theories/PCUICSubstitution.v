...
Inductive subs (Σ : global_context) (Γ : context) : list term -> context -> Type :=
| emptys : subs Σ Γ [] []
...
Lemma substitution_untyped_let_red Σ Γ Δ Γ' s M N :
...
Lemma untyped_substitution_red Σ Γ Δ Γ' s M N :
  wf Σ -> untyped_subslet Γ s Δ ->
  red Σ (Γ ,,, Δ ,,, Γ') M N ->

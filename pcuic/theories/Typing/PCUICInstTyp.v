...
Proof.
  ...
  is_open_term Γ A ->
  is_open_term Γ B ->
  Σ;;; Γ |- A =s B -> Σ;;; Δ |- A.[σ] =s B.[σ])); intros.
  ...
  - rename p0 into Hp'; rename p1 into Hreturn'; rename p2 into Hcontext'; rename p3 into Hc'; rename p4 into Hbrs'.
   ...
   - cbn. eapply cumul_Fix. cbn in H0, H1.         
     ...
     destruct X2 as [[Hx [[[_Htype [Htype Hbody_]] [Hbody Harg]] Hname]] Hy].
     repeat split; eauto.
     * eapply Htype; eauto. 
...
Proof. 
  ...
  - rename p0 into Hp'; rename p1 into Hreturn'; rename p2 into Hcontext'; rename p3 into Hc'; rename p4 into Hbrs'.
   ...
   - cbn. repeat rewrite inst_mkApps. eapply cumul_Ind.
     * repeat rewrite map_length; eauto.
     * rename b0 into Hargs, b into Hargs'; eapply forallb_All in Hargs, Hargs'.   
       apply (All2_All_mix_left Hargs) in X. clear Hargs.   
       apply (All2_All_mix_right Hargs') in X. clear Hargs'.
       apply All2_map. eapply All2_impl. 1: tea. cbn; intros.
       destruct X2 as [[Hx [Hxy_ Hxy]] Hy].    

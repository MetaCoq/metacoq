...
struct
  ...
  let tConstraintempty = UnivGen.constr_of_global (Coqlib.find_reference "template coq bug" (ext_pkg_univ "Constraint") "empty")
  let tConstraintadd = UnivGen.constr_of_global (Coqlib.find_reference "template coq bug" (ext_pkg_univ "Constraint") "add")

...
Definition tFixProp {A} (P P' : A -> Prop) (m : mfixpoint A) :=
...
Lemma map_def_spec {A B} (P P' : A -> Prop) (f f' g g' : A -> B) (x : def A) :
...
Lemma case_brs_map_spec {A B} {P : A -> Prop} {l} {f g : A -> B} :
...
Lemma tfix_map_spec {A B} {P P' : A -> Prop} {l} {f f' g g' : A -> B} :
...
Lemma case_brs_forallb_map_spec {A B} {P : A -> Prop} {p : A -> bool}
      {l} {f g : A -> B} :
  tCaseBrsProp P l ->

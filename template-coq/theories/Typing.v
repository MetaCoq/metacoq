...
| type_Case (indnparrel : inductive * nat * relevance) p c brs indices ps :
    ...
    forall btys, map_option_out (build_branches_type ind mdecl idecl p.(pparams) p.(puinst) ptm) = Some btys ->
